...
seed_lexicon = {
    "음식": [
        "맛", "음식", "메뉴", "맛집", "식사", "요리", "종류", "구성", "양"
    ],
    "서비스": [
        "친절", "사장", "직원", "기분", "추가", "서비스", "리필", "응대", "배려"
    ],
    "분위기": [
        "분위기", "느낌", "인테리어", "데이트", "편안", "매장", "힐링", "레트로", "추억",
    ],
    "가격": [
        "가성비", "가격", "혜자"
    ],
    # 식당 시설, 영업 시간, 대기 시간
    "편의성": [
        "주차", "주차장", "화장실", "냉방", "난방", "시간", "예약", "브레이크 타임", "웨이팅", "대기", "줄"
    ]
}
...
# 감정 사전의 기준 단어입니다.
pos_seeds = [
    "맛있", "좋", "많", "맛나", "편하", "넓", "괜찮", "예쁘", "크", "배부르", "이쁘", "잘",
